...
class CardType {
  static CardTypeEnum getType(List<PokerData> cards) {
  ...
  // 判断是否是顺子
  static bool _isStraight(List<PokerData> cards) {
  ...
  // 判断是否是连对
  static bool _isStraightPair(List<PokerData> cards) {
  ...
  // 判断是否是飞机
  static bool _isPlane(List<PokerData> cards) {
  ...
  // 判断是否是飞机带翅膀
  static bool _isPlaneWithWings(List<PokerData> cards) {
